  ...
  >
    ...
    > 
       <el-form-item label="生产批号" prop="batchNumber">
        <el-input v-model="dataForm.batchNumber" placeholder="生产批号" @blur='getInfo(dataForm.batchNumber)'></el-input>
      </el-form-item>
      <el-form-item label="产品名称" prop="productName">
        <!-- <el-input v-model="dataForm.productName" placeholder="产品名称" style="width:50%;"></el-input> -->
         <el-select v-model="dataForm.productName"  placeholder="请选择产品类型">
      ...
      <el-form-item label="生产厂家">
        <el-input v-model="dataForm.manufacturer" type="text" placeholder="生产厂家工号" ></el-input>
      </el-form-item>
      <el-form-item label="生产监督">
        <el-input v-model="dataForm.supervisioner" type="text" placeholder="生产监督" ></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getInfo(data){
      console.log(data);
       this.$http_
              .post(this.GLOBAL.baseUrlxg + "/productbatch/get", 
              {
                batchNumber:data
              }, {
                headers: {
